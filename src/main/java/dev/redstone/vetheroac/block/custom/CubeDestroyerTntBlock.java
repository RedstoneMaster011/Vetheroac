...
public class CubeDestroyerTntBlock extends BlockWithEntity {
    ...
    public CubeDestroyerTntBlock(Settings settings) {
        super(settings);
    }

    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new CubeDestroyerBlockEntity(pos, state);
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, VetheroacBlockEntities.CUBE_DESTROYER_BLOCK_ENTITY, CubeDestroyerBlockEntity::tick);
    }
    ...
    public void LightBlock(World world, BlockPos pos) {
        ...
        if (be instanceof CubeDestroyerBlockEntity tnt) {
            tnt.trigger();
        }
