...
public class ZombieTntBlock extends BlockWithEntity {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new ZombieTntBlockEntity(pos, state);
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, VetheroacBlockEntities.ZOMBIE_TNT_BLOCK_ENTITY, ZombieTntBlockEntity::tick);
    }
    ...
    public void LightBlock(World world, BlockPos pos) {
        ...
        if (be instanceof ZombieTntBlockEntity tnt) {
            tnt.trigger();
        }
