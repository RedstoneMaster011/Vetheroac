...
public class PowerfulTntBlock extends BlockWithEntity {
    ...
    public PowerfulTntBlock(Settings settings) {
        super(settings);
    }

    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new PowerfulTntBlockEntity(pos, state);
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, VetheroacBlockEntities.POWERFUL_TNT_BLOCK_ENTITY, PowerfulTntBlockEntity::tick);
    }
    ...
    public void LightBlock(World world, BlockPos pos) {
        ...
        if (be instanceof PowerfulTntBlockEntity tnt) {
            tnt.trigger();
        }
