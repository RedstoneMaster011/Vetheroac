...
public class SplitTntBlock extends BlockWithEntity {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new SplitTntBlockEntity(pos, state);
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, VetheroacBlockEntities.SPLIT_TNT_BLOCK_ENTITY, SplitTntBlockEntity::tick);
    }
    ...
    public void LightBlock(World world, BlockPos pos) {
        ...
        if (be instanceof SplitTntBlockEntity tnt) {
            tnt.trigger();
        }
