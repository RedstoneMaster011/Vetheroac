...
public class WARRIARTntBlock extends BlockWithEntity {
    ...
    public WARRIARTntBlock(Settings settings) {
        super(settings);
    }

    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new WARRIARTntBlockEntity(pos, state);
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, VetheroacBlockEntities.WARRIAR_TNT_BLOCK_ENTITY, WARRIARTntBlockEntity::tick);
    }
    ...
    public void LightBlock(World world, BlockPos pos) {
        ...
        if (be instanceof WARRIARTntBlockEntity tnt) {
            tnt.trigger();
        }
