...
public class DayTntBlock extends BlockWithEntity {
    ...
    public DayTntBlock(Settings settings) {
        super(settings);
    }

    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new DayTntBlockEntity(pos, state);
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, VetheroacBlockEntities.DAY_TNT_BLOCK_ENTITY, DayTntBlockEntity::tick);
    }
    ...
    public void LightBlock(World world, BlockPos pos) {
        ...
        if (be instanceof DayTntBlockEntity tnt) {
            tnt.trigger();
        }
