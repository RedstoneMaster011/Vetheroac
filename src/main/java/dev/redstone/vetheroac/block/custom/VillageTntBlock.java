...
public class VillageTntBlock extends BlockWithEntity {
    ...
    public VillageTntBlock(Settings settings) {
        super(settings);
    }

    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new VillageTntBlockEntity(pos, state);
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, VetheroacBlockEntities.VILLAGE_TNT_BLOCK_ENTITY, VillageTntBlockEntity::tick);
    }
    ...
    public void LightBlock(World world, BlockPos pos) {
        ...
        if (be instanceof VillageTntBlockEntity tnt) {
            tnt.trigger();
        }
